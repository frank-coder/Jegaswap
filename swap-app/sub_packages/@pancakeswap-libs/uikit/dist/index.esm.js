...
var Icon$1f = function (props) {
    var theme = useTheme();
    var primaryColor = theme.isDark ? "#E5AA70" : "#e9eaeb";
    var secondaryColor = theme.isDark ? "#EADDCA" : "#bdc2c4";
...
var Logo$2 = function (_a) {
  ...
  React.createElement("path", {
    fill: "#292020",
    d:
      "M-.5-.5h50v26c-2.433.286-2.433.952 0 2v39h-24c-.277-2.228-1.277-3.895-3-5-.17-1.322.163-2.489 1-3.5-3.783-.61-5.45-2.776-5-6.5l6-1v-5c-1.322.17-2.489-.163-3.5-1-.13-2.503-1.13-4.503-3-6a10.253 10.253 0 01-1.5 4l-1-.5c.88-1.356 1.213-2.856 1-4.5-4.062-.224-6.895-2.224-8.5-6A9.47 9.47 0 006.5 29c1.607.019 3.274.185 5 .5a32.437 32.437 0 01.5-8 29.95 29.95 0 002 9c1.555 1.646 3.221 1.98 5 1l2 2c1.91 9.336 3.41 9.17 4.5-.5-2.983-1.08-4.317-2.913-4-5.5.855-.793 1.689-.46 2.5 1 .5-5.657.666-11.324.5-17 6.406-.149 6.24-.815-.5-2-2.64.403-4.974 1.403-7 3L7 2.5c-2.918 4.927-3.918 10.26-3 16A937.321 937.321 0 007.5 13c-1.145-2.199-1.145-4.365 0-6.5 3.57 1.78 6.237 4.447 8 8-2.15.35-4.317-.317-6.5-2-.494 1.634-.66 3.3-.5 5h-3c-.074 3.726-1.574 6.726-4.5 9-.186 2.536-.686 4.869-1.5 7v-34z",
  }),
  React.createElement("path", {
    fill: "#ec2224",
    d: "M41.5.5c1.725.343 2.225 1.343 1.5 3-.667-1.333-1.333-1.333-2 0-.47-1.077-.303-2.077.5-3z",
  }),
  React.createElement("path", {
    fill: "#e2e5e5",
    d: "M22.5 61.5c-1.999-1.356-3.166-.69-3.5 2-.26-2.117-1.26-3.784-3-5l-1-8c-2.149-1.477-3.482-3.477-4-6-1.195 2.725-1.528 5.392-1 8l-5-8-1 3c-1.026-2.739-2.526-5.072-4.5-7v-7c.814-2.131 1.314-4.464 1.5-7 2.926-2.274 4.426-5.274 4.5-9h3c-.16-1.7.006-3.366.5-5 2.183 1.683 4.35 2.35 6.5 2-1.763-3.553-4.43-6.22-8-8-1.145 2.135-1.145 4.301 0 6.5A937.321 937.321 0 014 18.5c-.918-5.74.082-11.073 3-16l10 10c2.026-1.597 4.36-2.597 7-3 6.74 1.185 6.906 1.851.5 2 .166 5.676 0 11.343-.5 17-.811-1.46-1.645-1.793-2.5-1-.317 2.587 1.017 4.42 4 5.5-1.09 9.67-2.59 9.836-4.5.5l-2-2c-1.779.98-3.445.646-5-1a29.95 29.95 0 01-2-9 32.437 32.437 0 00-.5 8 29.816 29.816 0 00-5-.5A9.47 9.47 0 018 31.5c1.605 3.776 4.438 5.776 8.5 6 .213 1.644-.12 3.144-1 4.5l1 .5a10.253 10.253 0 001.5-4c1.87 1.497 2.87 3.497 3 6 1.011.837 2.178 1.17 3.5 1v5l-6 1c-.45 3.724 1.217 5.89 5 6.5-.837 1.011-1.17 2.178-1 3.5z",
  }),
  React.createElement("path", {
    fill: "#e82223",
    d: "M38.5 8.5a2.427 2.427 0 012 .5 31.857 31.857 0 01-5 4.5c-1.021-.502-1.188-1.168-.5-2a30.14 30.14 0 013.5-3z",
  }),
  React.createElement("path", {
    fill: "#ec2224",
    d: "M44.5 21.5c1.585.502 2.085 1.502 1.5 3-1.039-.744-1.539-1.744-1.5-3z",
  }),
  React.createElement("path", {
    fill: "#e52123",
    d: "M49.5 25.5v2c-2.433-1.048-2.433-1.714 0-2z",
  }),
  React.createElement("path", {
    fill: "#ec2224",
    d: "M30.5 30.5c.543.06.876.393 1 1-4.557 6.35-4.89 6.017-1-1z",
  }),
  React.createElement("path", {
    fill: "#ec2223",
    d: "M13.5 34.5c1.221-.965 2.554-.798 4 .5.95.718 1.117 1.55.5 2.5a30.85 30.85 0 01-4.5-3z",
  }),
  React.createElement("path", {
    fill: "#231f20",
    d:
      "M-.5 40.5c1.974 1.928 3.474 4.261 4.5 7l1-3 5 8c-.528-2.608-.195-5.275 1-8 .518 2.523 1.851 4.523 4 6l1 8c1.74 1.216 2.74 2.883 3 5 .334-2.69 1.501-3.356 3.5-2-1.468 1.28-2.135 2.946-2 5h-21v-26z",
  }),
  React.createElement("path", {
    fill: "#e92223",
    d: "M43.5 43.5c1.405 1.725 1.905 3.725 1.5 6-1.685-2.488-3.019-2.154-4 1 .237-2.489 1.07-4.822 2.5-7z",
  }),
  React.createElement("path", {
    fill: "#a42323",
    d: "M28.5 49.5c.543.06.876.393 1 1-.865 1.083-1.865 1.25-3 .5.916-.278 1.582-.778 2-1.5z",
  }),
  React.createElement("path", {
    fill: "#e6e9e8",
    d: "M22.5 51.5a4.932 4.932 0 013 .5 24.36 24.36 0 01-5.5 2.5l-.5-1a44.293 44.293 0 003-2z",
  }),
  React.createElement("path", {
    fill: "#e5e8e8",
    d: "M22.5 61.5c1.723 1.105 2.723 2.772 3 5h-5c-.135-2.054.532-3.72 2-5z",
  }),
  React.createElement("path", {
    fill: "#ec2223",
    d: "M29.5 62.5c2.5.01 2.668.678.5 2a2.428 2.428 0 01-.5-2z",
  })
);
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "JegaSwap home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "JegaSwap home page" }, innerLogo))));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#E5AA70", backgroundDisabled: "#9595e9", contrast: "#311b17", dropdown: "#F6F6F6", invertedContrast: "#FFFFFF", bright: "#ffffff", blue: "#17D2FB", input: "#ffffff", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#ffffff", textDisabled: "#dad5d5", textSubtle: "#8c8c8c", borderColor: "#551b10", card: "#7e3844", menuHover: "#F7AD19", gradients: {
        bluePurple: "linear-gradient(90.82deg, #FA00FF -73.84%, #17D2FB 141.1%)",
        bubblegum: "linear-gradient(245.94deg, rgb(242, 210, 189, 0.9) -63.8%, rgb(242, 210, 189, 0.5) 73.44%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#a279f5", background: "#F2D2BD", backgroundDisabled: "#9595e9", contrast: "#FFFFFF", dropdown: "#2c2624", invertedContrast: "#662a1e", bright: "#ffffff", blue: "#17D2FB", input: "#7a534c", inputSecondary: "#b18179", primaryDark: "#c73316", tertiary: "#8a6058", text: "#f0745c", textDisabled: "#745a55", textSubtle: "#fc7358", borderColor: "#e67761", card: "#27262c", menuHover: "#F7AD19", gradients: {
        bluePurple: "linear-gradient(90.82deg, #FA00FF -73.84%, #17D2FB 141.1%)",
        bubblegum: "linear-gradient(245.94deg,rgb(242, 210, 189, 0.9) -63.8%, rgb(242, 210, 189, 0.5) 73.44%)",
    } });
